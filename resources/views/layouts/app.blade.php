        ...
        <div class="top_bar">
            <div class="container">
                <div class="row">
                    <div class="col d-flex flex-row">
                        ...
                        <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{ asset('frontend/images/mail.png')}}" alt=""></div><a href="mailto:djibou78@gmail.com">{{ $setting->email }}</a></div>
            ...
            <a href="" data-toggle="modal" data-target="#exampleModal">My Order Traking</a>                   
                ...
                @endphp
                                ...
                                @else
                                 <a href="{{ route('language.french') }}">French<i class="fas fa-chevron-down"></i></a>
                                @endif          
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="{{ url('/') }}"><img src="{{ asset('frontend/images/logo1.png')}}" alt=""></a></div>
                        </div>
                    </div>
