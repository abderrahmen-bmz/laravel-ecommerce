 ...
 <a href="{{ route('all.blogpost')}}" class="btn btn-success btn-sm pull-right"> All Post</a>
        ...
        @csrf
          ...
          <div class="form-layout">
            <div class="row mg-b-25">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Post Title (French): <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="post_title_fr"  placeholder="Enter Post Title in French">
                </div>
              </div><!-- col-4 -->
       ...
       <select class="form-control select2" data-placeholder="Choose country" name="category_id">
            ...
            <textarea class="form-control" id="summernote"  name="details_en"> 
               ...
               <div class="col-lg-12">
                <div class="form-group">
                  <label class="form-control-label">Product Details (French): <span class="tx-danger">*</span></label>
  
            <textarea class="form-control" id="summernote1"  name="details_fr"> 
