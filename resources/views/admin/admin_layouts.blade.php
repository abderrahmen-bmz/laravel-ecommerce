...
<link href="https://cdn.jsdelivr.net/bootstrap.tagsinput/0.8.0/bootstrap-tagsinput.css" rel="stylesheet"/>
 ...
 <!-- chart -->
         <link rel="stylesheet" type="text/css" href="{{asset('css_js/toastr.css')}}">
...
<!-- Datatable css -->
  ...
  <body>
     ...
     @else
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Chlef_Tech</a></div>
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 active" id="messages" role="tabpanel">
          <div class="media-list">
            ...
            <a href="" class="media-list-link">
              <div class="media">
                <img src="{{asset('backend/img/img2.jpg')}}" class="wd-40 rounded-circle" alt="">
...
<script>
 ...
 <script type="text/javascript" src="{{asset('css_js/toastr.min.js')}}"></script>

  <script src="{{asset('css_js/sweetalert.min.js')}}"></script>
